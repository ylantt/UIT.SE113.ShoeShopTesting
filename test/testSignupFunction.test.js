...
fixture('Test Sign-up function').page(process.env.URL_TEST)
...
test('SignUp01 - Should redirect to verify page if sign up valid ', async (t) => {
  ...
  await t
    ...
    .expect(getLocation())
    .contains(`${process.env.URL_TEST}/verify`)
})
...
test('SignUp04 - should display Please fill in all fields', async (t) => {
  await t
    ...
    .selectText(signUp_fullname)
    .pressKey('delete')
    .selectText(signUp_username)
    .pressKey('delete')
    .selectText(signUp_email)
    .pressKey('delete')   
    .selectText(signUp_phone)
    .pressKey('delete')    
    .selectText(signUp_password)
    .pressKey('delete')    
    .selectText(signUp_confirmpass)
    .pressKey('delete')    
...
test('SignUp05 - should display Duplicate email or username, please try again', async (t) => {
  await t
    ...
    .click(signUp_submitBtn)
    .expect(signUp_errormsg.innerText)
    .eql('Duplicate email or username, please try again')
})
